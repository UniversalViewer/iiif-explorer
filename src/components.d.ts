...
declare namespace LocalJSX {
  interface IiifExplorer extends JSXBase.HTMLAttributes<HTMLIiifExplorerElement> {
    'manifest'?: string;
  ...
  interface IiifExplorerBreadcrumb extends JSXBase.HTMLAttributes<HTMLIiifExplorerBreadcrumbElement> {
    'collection'?: Collection;
    'onSelectBreadcrumb'?: (event: CustomEvent<any>) => void;
  }
  interface IiifExplorerItem extends JSXBase.HTMLAttributes<HTMLIiifExplorerItemElement> {
    'item'?: IIIFResource;
