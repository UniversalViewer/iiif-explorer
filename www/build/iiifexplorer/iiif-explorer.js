...
var IIIFExplorer = /** @class */ (function () {
    ...
    IIIFExplorer.prototype._switchToFolder = function (node) {
        if (!node.isLoaded) {
        ...
        if (!this.data) {
            ...
            return (h("div", 0,
                ...
                h("div", { "c": { "items": true } }, this.data.current.members.map(function (item) {
                    return h("iiif-explorer-item", { "p": { "item": item, "selected": _this._selected === item } });
                }))));
        }
    };
